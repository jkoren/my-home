      ...
      <div className="cell small-offset-1 medium-offset-3 "> 
        <div className="grid-x grid-margin-y text-center">
          <div className="callout cell small-10 medium-6 box-shadow">
            ...
            <h4 className="cell"> My-Home is a single site for information on using the technology in your life. It’s a site for manuals and operating videos, and to find repair professionals.   Everything that came with your house is included. Feel free to add more. </h4>
